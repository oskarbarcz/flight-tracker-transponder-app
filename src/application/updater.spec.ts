...
import type { Downloader, DownloadRequest } from './ports/downloads';
  ...
  return {
    ...
    updater: new Updater(
      ...
      logger,
      {
        directory:
          overrides.directory ??
          (() => Promise.resolve('/Users/pilot/Downloads')),
        ensureWritable: overrides.prepare ?? (() => true),
        uniquePath: (directory, fileName) => `${directory}/${fileName}`,
      },
    ),
  };
}
